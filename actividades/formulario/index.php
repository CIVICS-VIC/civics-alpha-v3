...
<head>
  ...
  <title>CIVICS Formulario Actividades</title>
...
<body>
  ...
  <div id="contact-form"> 
   ...
   <h2>Usa el formulario para incluir tu nueva actividad en el mapa de </h2> 
   ...
   <form method="post" action="processFormData.php">
     ...
     <!--Activity basic data--> 
      ...
      <input type="text" id="activity" name="activity" value="" placeholder="Escribe aquí el nombre de la actividad" autofocus required/>       
         
      <label for="short_description">Descripción de la actividad <span class="required">*</span></label> 
      <textarea rows="4" cols="50" maxlength="500" id="long_description" name="long_description" value="" placeholder="Escribe aquí una breve descripción (menos de 500 caracteres)" autofocus required></textarea>
      
      <label for="web_activity">Web con info adicional sobre la actividad <span class="required">*</span></label> 
      ...
      <select id="category_type" name="category_type">        
         ...
         <option value="Curso">Curso/Convocatoria</option>
      ...
      <?php //modificado CS ?>
      <label for="datetime_start">Inicio Actividad <span class="required">*</span></label> 
      <input type="datetime" id="datetime_start" name="datetime_start" min="2014-01-01T00:00:00" placeholder="Fecha y hora del inicio de la actividad" autofocus required/>
     ...
     <h3>Localiza la actividad</h3>
      ...
      <!--MAP PICKER geoposition data for activities-->
      	
     <fieldset class="gllpLatlonPicker">
      	<label for="address">Dirección: <span class="required">*</span></label> 
      	<input type="text" id="address" name="address" class="gllpSearchField"  value="" placeholder="Calle X, 12, 5ºH" autofocus required/>
     ...
     <!--Initiative data--> 
    <h3>Información sobre la Iniciativa o la Persona que organiza la actividad</h3>
    ...
    <option value="ini_other">Aun no registrada</option> 
      ...
      <h4>Si tu iniciativa no está registrada, por favor, indica "Aún no registrada" en el desplegable anterior y rellena el siguiente formulario. </h4>
